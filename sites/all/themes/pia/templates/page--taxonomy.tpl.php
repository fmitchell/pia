	...
	<div class="main-holder">
		<div class="main-frame">
			<div id="content">
				<?php
					$term_id = arg(2);
					$_term = taxonomy_term_load($term_id);
				?>
				<?php
				if(isset($_term->field_image['und'][0])){
					$nimage = theme('image_formatter',
								array('item' => $_term->field_image['und'][0],
									'image_style' => 'basic_page',
									'path' => array('path' => '','options' => '')
							));
					if($nimage){
				...
				<?php if($_term->vocabulary_machine_name == 'events'): ?>
