...
$config['LicenseName'] = 'partnershipsinaction.org';
$config['LicenseKey'] = 'T6A6-TMX3-R35P-9V7C-1EBT-73FT-X1MX';
...
Examples:
	$baseUrl = 'http://partnershipsinaction.org/sites/default/files/images/';
	$baseUrl = '/userfiles/';

ATTENTION: The trailing slash is required.
*/
$baseUrl = '/public_html/sites/default/files/images';
